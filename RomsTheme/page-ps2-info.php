...
<div class="ps2-container">
    ...
    <div class="header-hero">
        <img 
        src="<?php echo get_template_directory_uri(); ?>/assets/Principal-historia.jpg" 
    ...
    <div class="data-grid-wrapper">
        ...
        <div class="data-grid-item">
            ...
            <img 
                src="<?php echo get_template_directory_uri(); ?>/assets/Historia-3.jpg" 
                alt="Imagen principal de la landing page" 
            />
        </div>
    ...
    <div class="models-wrapper">
        ...
        <div class="model-card">
            <div class="model-images">
                ...
                <img 
                    src="<?php echo get_template_directory_uri(); ?>/assets/PS2-Fat-Console-Set.jpg" 
                    alt="Imagen principal de la landing page" 
                />
            </div>
        ...
        <div class="model-card">
            <div class="model-images">
                ...
                <img 
                    src="<?php echo get_template_directory_uri(); ?>/assets/PS2_Slim.jpg" 
                    alt="Imagen principal de la landing page" 
                />
            </div>
            <h3>Modelo Slim</h3>
